...
var AppComponent = /** @class */ (function () {
    function AppComponent() {
        this.title = 'Manufacturing Asset Real Time Dashboard';
    }
...
/***/ "./src/app/features/assets/asset.ts":
/*!******************************************!*\
  !*** ./src/app/features/assets/asset.ts ***!
  \******************************************/
...
/* harmony import */ var _assets_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./assets.component */ "./src/app/features/assets/assets.component.ts");
...
var AssetsModule = /** @class */ (function () {
    ...
    AssetsModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_assets_component__WEBPACK_IMPORTED_MODULE_2__["AssetsComponent"]]
        })
    ], AssetsModule);
    return AssetsModule;
}());
...
/***/ "./src/app/features/dashboard/dashboard-chart/dashboard-chart.component.html":
/*!***********************************************************************************!*\
  !*** ./src/app/features/dashboard/dashboard-chart/dashboard-chart.component.html ***!
  \***********************************************************************************/
/*! no static exports found */
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _assets_asset__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../assets/asset */ "./src/app/features/assets/asset.ts");
...
var DashboardChartComponent = /** @class */ (function () {
    ...
    DashboardChartComponent.prototype.initHistoryMap = function (assets) {
        ...
        for (var i = 0; i < assets.length && assets[i]; i++) {
            if (historyMap.get(assets[i].id) == null) {
                var startList = [];
    ...
    DashboardChartComponent.prototype.filterData = function (selectedAssetAnalysis) {
    ...
    DashboardChartComponent.prototype.buildChart = function (data) {
        console.log("build chart");
        new chart_js__WEBPACK_IMPORTED_MODULE_3___default.a(document.getElementById("line-chart"), {
            type: 'line',
            data: data,
            options: {
                title: {
    ...
    __decorate([
        ...
        __metadata("design:type", _assets_asset__WEBPACK_IMPORTED_MODULE_1__["Asset"])
    ], DashboardChartComponent.prototype, "selectedAsset", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], DashboardChartComponent.prototype, "dataSource", void 0);
    DashboardChartComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'dashboard-chart',
            template: __webpack_require__(/*! ./dashboard-chart.component.html */ "./src/app/features/dashboard/dashboard-chart/dashboard-chart.component.html"),
            styles: [__webpack_require__(/*! ./dashboard-chart.component.css */ "./src/app/features/dashboard/dashboard-chart/dashboard-chart.component.css")]
        })
...
/***/ "./src/app/features/dashboard/dashboard-table/dashboard-table.component.css":
/*!**********************************************************************************!*\
  !*** ./src/app/features/dashboard/dashboard-table/dashboard-table.component.css ***!
  \**********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/features/dashboard/dashboard-table/dashboard-table.component.html":
/*!***********************************************************************************!*\
  !*** ./src/app/features/dashboard/dashboard-table/dashboard-table.component.html ***!
  \***********************************************************************************/
/*! no static exports found */
...
/***/ "./src/app/features/dashboard/dashboard-table/dashboard-table.component.ts":
/*!*********************************************************************************!*\
  !*** ./src/app/features/dashboard/dashboard-table/dashboard-table.component.ts ***!
  \*********************************************************************************/
...
var DashboardTableComponent = /** @class */ (function () {
    ...
    ], DashboardTableComponent.prototype, "selectedAsset", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_1__["MatSort"]),
        __metadata("design:type", _angular_material__WEBPACK_IMPORTED_MODULE_1__["MatSort"])
    ], DashboardTableComponent.prototype, "sort", void 0);
    DashboardTableComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'dashboard-table',
            template: __webpack_require__(/*! ./dashboard-table.component.html */ "./src/app/features/dashboard/dashboard-table/dashboard-table.component.html"),
            styles: [__webpack_require__(/*! ./dashboard-table.component.css */ "./src/app/features/dashboard/dashboard-table/dashboard-table.component.css")]
        })
...
/* harmony import */ var _routes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./routes */ "./src/app/features/routes.ts");
...
/* harmony import */ var _shared_shared_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../shared/shared.module */ "./src/app/shared/shared.module.ts");
/* harmony import */ var _assets_assets_module__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./assets/assets.module */ "./src/app/features/assets/assets.module.ts");
/* harmony import */ var _dashboard_dashboard_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./dashboard/dashboard.module */ "./src/app/features/dashboard/dashboard.module.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    FeaturesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _assets_assets_module__WEBPACK_IMPORTED_MODULE_6__["AssetsModule"],
            ...
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_2__["RouterModule"], _dashboard_dashboard_module__WEBPACK_IMPORTED_MODULE_7__["DashboardModule"], _assets_assets_module__WEBPACK_IMPORTED_MODULE_6__["AssetsModule"]]
        })
    ], FeaturesModule);
...
/***/ "./src/app/shared/assetAnalysis/assetAnalysis.component.css":
/*!******************************************************************!*\
  !*** ./src/app/shared/assetAnalysis/assetAnalysis.component.css ***!
  \******************************************************************/
/*! no static exports found */
...
/***/ "./src/app/shared/assetAnalysis/assetAnalysis.component.html":
/*!*******************************************************************!*\
  !*** ./src/app/shared/assetAnalysis/assetAnalysis.component.html ***!
  \*******************************************************************/
/*! no static exports found */
...
module.exports = "<div class='assetAnalysis'>\n   <div [ngStyle] = \"{'text-align':'center','background':'lightgrey', 'border':'2px solid', 'height': '40vh'}\">\n      <h4 [ngStyle] = \"{'border-bottom':'2px solid','background-color':asset.riskColor}\">Asset {{asset.id}}</h4>\n      <p> Type : {{asset.type}} </p>\n      <p> Rotation : {{asset.rotation}} </p>\n      <p> Version : {{asset.version}} </p>\n      <p> Current : {{asset.current}} </p>\n      <p> Pressure : {{asset.pressure}} </p>\n      <p> Flow Rate : {{asset.flowRate}} </p>\n      <p> Temperature : {{asset.temperature}} </p>\n      <p> Latitude : {{asset.latitude}} </p>\n      <p> Longitude : {{asset.longitude}} </p>\n   </div>\n</div>\n"

/***/ }),

/***/ "./src/app/shared/assetAnalysis/assetAnalysis.component.ts":
/*!*****************************************************************!*\
  !*** ./src/app/shared/assetAnalysis/assetAnalysis.component.ts ***!
  \*****************************************************************/
/*! exports provided: AssetAnalysis */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AssetAnalysis", function() { return AssetAnalysis; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _features_assets_asset__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../features/assets/asset */ "./src/app/features/assets/asset.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AssetAnalysis = /** @class */ (function () {
    function AssetAnalysis() {
    }
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", _features_assets_asset__WEBPACK_IMPORTED_MODULE_1__["Asset"])
    ], AssetAnalysis.prototype, "asset", void 0);
    AssetAnalysis = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'assetAnalysis',
            template: __webpack_require__(/*! ./assetAnalysis.component.html */ "./src/app/shared/assetAnalysis/assetAnalysis.component.html"),
            styles: [__webpack_require__(/*! ./assetAnalysis.component.css */ "./src/app/shared/assetAnalysis/assetAnalysis.component.css")]
        })
    ], AssetAnalysis);
...
/***/ "./src/app/shared/leafletMap/greenMapIcon.svg":
/*!****************************************************!*\
  !*** ./src/app/shared/leafletMap/greenMapIcon.svg ***!
  \****************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "greenMapIcon.svg";

/***/ }),

/***/ "./src/app/shared/leafletMap/leafletMap.component.css":
/*!************************************************************!*\
  !*** ./src/app/shared/leafletMap/leafletMap.component.css ***!
  \************************************************************/
/*! no static exports found */
...
/***/ "./src/app/shared/leafletMap/leafletMap.component.html":
/*!*************************************************************!*\
  !*** ./src/app/shared/leafletMap/leafletMap.component.html ***!
  \*************************************************************/
/*! no static exports found */
...
/***/ "./src/app/shared/leafletMap/leafletMap.component.ts":
/*!***********************************************************!*\
  !*** ./src/app/shared/leafletMap/leafletMap.component.ts ***!
  \***********************************************************/
...
var LeafletMap = /** @class */ (function () {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], LeafletMap.prototype, "id", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", Array)
    ], LeafletMap.prototype, "assets", void 0);
    LeafletMap = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'leafletMap',
            template: __webpack_require__(/*! ./leafletMap.component.html */ "./src/app/shared/leafletMap/leafletMap.component.html"),
            styles: [__webpack_require__(/*! ./leafletMap.component.css */ "./src/app/shared/leafletMap/leafletMap.component.css")]
        })
    ], LeafletMap);
    return LeafletMap;
}());
...
/***/ "./src/app/shared/leafletMap/redMapIcon.svg":
/*!**************************************************!*\
  !*** ./src/app/shared/leafletMap/redMapIcon.svg ***!
  \**************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "redMapIcon.svg";

/***/ }),

/***/ "./src/app/shared/leafletMap/yellowMapIcon.svg":
/*!*****************************************************!*\
  !*** ./src/app/shared/leafletMap/yellowMapIcon.svg ***!
  \*****************************************************/
/*! no static exports found */
...
module.exports = __webpack_require__.p + "yellowMapIcon.svg";
...
/* harmony import */ var _assetAnalysis_assetAnalysis_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./assetAnalysis/assetAnalysis.component */ "./src/app/shared/assetAnalysis/assetAnalysis.component.ts");
/* harmony import */ var _leafletMap_leafletMap_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./leafletMap/leafletMap.component */ "./src/app/shared/leafletMap/leafletMap.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SharedModule = /** @class */ (function () {
    ...
    SharedModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [_tile_tile_component__WEBPACK_IMPORTED_MODULE_3__["TileComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_4__["HeaderComponent"], _footer_footer_component__WEBPACK_IMPORTED_MODULE_5__["FooterComponent"], _assetRisk_assetRisk_component__WEBPACK_IMPORTED_MODULE_6__["AssetRisk"], _assetAnalysis_assetAnalysis_component__WEBPACK_IMPORTED_MODULE_7__["AssetAnalysis"], _leafletMap_leafletMap_component__WEBPACK_IMPORTED_MODULE_8__["LeafletMap"]],
            exports: [_tile_tile_component__WEBPACK_IMPORTED_MODULE_3__["TileComponent"], _header_header_component__WEBPACK_IMPORTED_MODULE_4__["HeaderComponent"], _footer_footer_component__WEBPACK_IMPORTED_MODULE_5__["FooterComponent"], _assetRisk_assetRisk_component__WEBPACK_IMPORTED_MODULE_6__["AssetRisk"], _assetAnalysis_assetAnalysis_component__WEBPACK_IMPORTED_MODULE_7__["AssetAnalysis"], _leafletMap_leafletMap_component__WEBPACK_IMPORTED_MODULE_8__["LeafletMap"]]
        })
    ], SharedModule);
    return SharedModule;
}());
