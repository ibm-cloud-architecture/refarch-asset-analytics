...
### Asset and Event Datasource: Deploy Cassandra
...
See instructions [in the project repository](https://github.com/ibm-cloud-architecture/refarch-asset-manager-microservice/blob/microprofile/docs/icp.md#run-the-app) to deploy it using helm.
 If you want to install it on your local kubernetes cluster we are providing a script under this project folder: `refarch-asset-manager-microservice/scripts/deployLocal.sh`
